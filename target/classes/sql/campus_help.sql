...
CREATE TABLE `school` (
  ...
  `domain` varchar(18) NOT NULL COMMENT '学校邮箱域名',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `school` VALUES (13,'武汉大学','whu.edu.cn');
...
INSERT INTO `user` VALUES (14,'2021300004042','e10adc3949ba59abbe56e057f20f883e','13008778787','2021300004042@whu.edu.cn',13,14,1,0,'顾田','2024-09-29 16:50:28',23,0,Null,Null),
                          (15,'2021300004048','e10adc3949ba59abbe56e057f20f883e','123456','2021300004048@whu.edu.cn',13,14,1,0,'邢益鸣','2024-10-01 03:31:23',362,0,Null,Null),
                        (16,'2020300004007','e10adc3949ba59abbe56e057f20f883e','19852278359','2020300004007@whu.edu.cn',13,14,1,0,'于凯','2024-11-12 14:34:22',0,0,Null,Null);
