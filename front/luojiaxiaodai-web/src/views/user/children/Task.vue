  ...
  <div class="content">
    ...
    <el-card class="box-card card">
      ...
      <div class="input">
        ...
        <el-input placeholder="请输入奖励（单位：元）" v-model="reward" oninput="value=value.replace(/[^\d]/g,'')"
                  :class="{'is-empty':rewardEmpty}" @blur="rewardValidate"></el-input>
      ...
      <el-card class="box-card">
        ...
        <div class="input">
          ...
          <el-input placeholder="请输入快递点" v-model="expressPoint"
                    :class="{'is-empty':expressPointEmpty}" @blur="expressPointValidate"></el-input>
        </div>
        <div class="input">
          <div class="append">取件码 *</div>
          <el-input placeholder="请输入取件码" v-model="code"
                    :class="{'is-empty':codeEmpty}" @blur="codeValidate"></el-input>
        </div>
        <div class="input">
        ...
        <div class="input">
          ...
          <el-input placeholder="请输入收件人姓名" v-model="name"
                    :class="{'is-empty':nameEmpty}" @blur="nameValidate"></el-input>
        </div>
        <div class="input">
          <div class="append">收件人电话 *</div>
          <el-input placeholder="请输入收件人电话" v-model="phone"
                    :class="{'is-empty':phoneEmpty}" @blur="phoneValidate"></el-input>
        </div>
        <div class="input">
          <div class="append">收件人地址 *</div>
          <el-input placeholder="请输入收件人地址" v-model="address"
                    :class="{'is-empty':addressEmpty}" @blur="addressValidate"></el-input>
        </div>
        <div class="input">
          <div class="append">备注</div>
          <el-input placeholder="您可以输入备注" v-model="comment"></el-input>
        </div>
      </el-card>
    </el-card>
    <el-drawer
...
export default {
  ...
  methods: {
    ...
    drawerClose(){
      location.reload() // 重置输入的数据
    },
    rewardValidate() {
      this.rewardEmpty = this.reward === ''
    },
    expressPointValidate() {
      this.expressPointEmpty = this.expressPoint === ''
    },
    codeValidate() {
      this.codeEmpty = this.code === ''
    },
    nameValidate() {
    ...
    addressValidate() {
      this.addressEmpty = this.address === ''
    },
  },
  created() {
    this.renew()
